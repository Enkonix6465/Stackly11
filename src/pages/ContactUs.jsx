...
const locations = [
  {
    cityKey: "contact.locations.0.city",
    addressKey: "contact.locations.0.address",
    phoneKey: "contact.locations.0.phone",
  },
  {
    cityKey: "contact.locations.1.city",
    addressKey: "contact.locations.1.address",
    phoneKey: "contact.locations.1.phone",
  },
  {
    cityKey: "contact.locations.2.city",
    addressKey: "contact.locations.2.address",
    phoneKey: "contact.locations.2.phone",
  },
];
...
const FAQS = [
  {
    questionKey: "contact.faqs.0.question",
    answerKey: "contact.faqs.0.answer",
  },
  {
    questionKey: "contact.faqs.1.question",
    answerKey: "contact.faqs.1.answer",
  },
  {
    questionKey: "contact.faqs.2.question",
    answerKey: "contact.faqs.2.answer",
  },
  {
    questionKey: "contact.faqs.3.question",
    answerKey: "contact.faqs.3.answer",
  },
];
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full h-full">
          ...
          <p
            className="max-w-2xl mx-auto text-lg drop-shadow-lg text-center"
            style={{ color: COLOR_2 }}
            data-aos="fade-up"
          >
          ...
          <div className="flex flex-col md:flex-row items-stretch justify-center gap-8">
            {locations.map((loc, i) => (
              ...
              >
                ...
                <p className="mb-2">{t(loc.addressKey)}</p>
                <p className="mb-1 font-semibold" style={{ color: COLOR_1 }}>
                  {t("contact.phoneLabel")}: {t(loc.phoneKey)}
                </p>
