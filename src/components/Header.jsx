...
export default function Header() {
  ...
  return (
    <header
      className={` sticky z-50 w-full shadow-lg transition-colors duration-300 border-b ${darkMode
    ...
    >
      <div className="   mx-auto w-full py-2 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-4   ">
          ...
          <div className="relative">
            <span
              className={`text-base cursor-pointer font-semibold flex items-center gap-1 ${darkMode ? "text-[#eebbc3]" : "text-[#232946]"}   rounded-lg focus:outline-none transition-all duration-200  `}
            ...
            {homeDropdown && (
              ...
              >
                <Link
                  to="/home"
                  className={`block px-4 py-3 text-base transition-colors duration-200 ${darkMode
          ...
          <Link
            to="/about"
            className={`text-base font-semibold px-4 py-2 rounded-lg   transition-all duration-200 ${darkMode ? "text-[#eebbc3]" : "text-[#232946]"}  `}
            onClick={scrollToTop}
          ...
          <div className="relative">
            ...
            {servicesDropdown && (
              <div
                className={`absolute left-0 mt-2 w-60 border rounded-xl shadow-xl z-50 transition-colors duration-200 ${darkMode
              ...
              >
                <div
                  className={`block px-4 py-2 text-base rounded-lg transition-colors duration-200 cursor-pointer border-b ${darkMode
                ...
                <div
                  className={`block px-4 py-2 text-base rounded-lg transition-colors duration-200 cursor-pointer ${darkMode
                    ? "text-[#eebbc3] hover:bg-[#313866] hover:text-[#eebbc3]"
                    : "text-[#232946] hover:bg-[#e0e7ef] hover:text-[#232946]"
                    }`}
                  onClick={() => {
                ...
                <div
                  className={`block px-4 py-3 text-base transition-colors duration-200 cursor-pointer ${darkMode
                    ? "text-[#eebbc3] hover:bg-[#313866] hover:text-[#eebbc3]"
                    : "text-[#232946] hover:bg-[#e0e7ef] hover:text-[#232946]"
                    }`}
                  onClick={() => {
                ...
                <div
                  className={`block px-4 py-3 text-base hover:bg-ice transition-colors duration-200 cursor-pointer ${darkMode
          ...
          <button
            ...
            className={`p-2 rounded-full border-2 shadow-md transition-colors duration-200 ml-2 ${darkMode
          ...
          <div className="relative  avatar-dropdown ml-4">
            <div
              ...
              className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-base cursor-pointer border-2 shadow-md transition-all duration-200 ${darkMode
            ...
            {isAvatarDropdownOpen && (
              <div
                className={`absolute right-0 mt-2 w-56 border rounded-xl shadow-xl z-50 ${darkMode
                  ? "bg-[#232946] border-[#313866]"
                  : "bg-white border-[#e0e7ef]"
                  }`}
              >
                <div className="py-2">
                  <div
                    className={`px-4 py-2 text-sm border-b ${darkMode
                  ...
                  >
                    ...
                    <div
                      className={`text-xs ${darkMode ? "text-[#eebbc3]" : "text-[#232946]"
                        }`}
                    >
                      Signed in
                    </div>
                  ...
                  <button
                    ...
                    className={`w-full text-left px-4 py-2 text-sm rounded-lg flex items-center transition-colors duration-200 mb-1 ${darkMode
                      ? "text-[#eebbc3] hover:bg-[#313866] hover:text-[#eebbc3]"
                      : "text-[#232946] hover:bg-[#e0e7ef] hover:text-[#232946]"
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`w-full text-left px-4 py-2 text-sm rounded-lg flex items-center transition-colors duration-200 ${darkMode
          ...
          <div className=" relative">
            <button
              className={`text-base font-semibold flex items-center gap-1 px-4 py-2 rounded-lg focus:outline-none transition-all duration-200 shadow-sm border ${darkMode
            ...
            {isLangDropdownOpen && (
              <div
                className={`absolute left-0 mt-2 w-44 border rounded-xl shadow-xl z-50 transition-colors duration-200 ${darkMode
                  ? "bg-[#232946] border-[#313866]"
                  : "bg-white border-[#e0e7ef]"
                  }`}
              >
        ...
        <div className="lg:hidden flex items-center gap-2">
          ...
          <button
            onClick={toggleDarkMode}
            className={`p-2 rounded-full border-2 shadow-md transition-colors duration-200 ${darkMode
              ? "bg-[#232946] border-[#eebbc3] text-[#eebbc3] hover:bg-[#313866] hover:text-white"
              : "bg-[#e0e7ef] border-[#232946] text-[#232946] hover:bg-[#c7d2fe] hover:text-[#1e293b]"
              }`}
            title={darkMode ? "Switch to Light Mode" : "Switch to Dark Mode"}
          ...
          >
            <svg
              className={`w-6 h-6 transition-transform duration-200 ${darkMode ? "text-white" : "text-gray-600"
      ...
      {isMobileMenuOpen && (
        <div
          className={`lg:hidden border-t ${darkMode
            ? "border-gray-700 bg-gray-900"
            : "border-gray-200 bg-white"
            }`}
        >
          <div
            className={`px-4 py-6 space-y-4 max-h-[70vh] overflow-y-auto scroll-smooth [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 [&::-webkit-scrollbar-thumb]:rounded-full ${darkMode
          ...
          >
            ...
            <div className="relative">
              <button
                className={`w-full text-left flex items-center justify-between py-3 px-4 rounded-lg font-semibold transition-colors duration-200 ${darkMode
              ...
              {homeDropdown && (
                <div className="ml-4 mt-2 space-y-2">
                  <Link
                    ...
                    className={`block py-2 px-4 rounded-lg transition-colors duration-200 ${darkMode
            ...
            <Link
              to="/about"
              onClick={closeMobileMenu}
              className={`block py-3 px-4 rounded-lg font-semibold transition-colors duration-200 ${darkMode
              ...
              {mobileServicesDropdown && (
                <div className="ml-4 mt-2 space-y-2">
                  <div
                    ...
                    className={`block py-2 px-4 rounded-lg transition-colors duration-200 cursor-pointer ${darkMode
                      ? "text-gray-300 hover:bg-gray-800"
                      : "text-gray-600 hover:bg-gray-100"
                      }`}
                  >
            ...
            <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
              ...
              <button
                ...
                className={`w-full text-left px-4 py-3 mt-2 text-sm font-semibold rounded-lg transition-colors duration-200 flex items-center
                  ${darkMode
                    ? "text-[#000000] hover:bg-[#313866] hover:text-white"
                    : "text-[#232946] hover:bg-[#e0e7ef] hover:text-[#1e293b]"
                  }`}
              >
                <svg
