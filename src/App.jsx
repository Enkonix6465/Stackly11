    ...
    <DarkModeProvider>
      <Router>
        ...
        <Routes>
          ...
          <Route path="/services/urban-planning" element={<UrbanPlanning user={user} onLogout={handleLogout} />} />
          ...
          <Route path="/services/industrial-facilities" element={<IndustrialFacilities user={user} onLogout={handleLogout} />} />
          <Route path="/services/commercial-complexes" element={<CommercialComplexes user={user} onLogout={handleLogout} />} />
          <Route path="/services/residential-projects" element={<ResidentialProjects user={user} onLogout={handleLogout} />} />
          <Route path="/services/interior-design" element={<InteriorDesign user={user} onLogout={handleLogout} />} />
          <Route path="/services" element={<Services user={user} onLogout={handleLogout} />} />
          <Route path="/services/renovation-restoration" element={<RenovationRestoration user={user} onLogout={handleLogout} />} />
          ...
          <Route path="/blog/2025-design-trends-modern-architecture" element={<ModernArchitecture user={user} onLogout={handleLogout} />} />
          <Route path="/blog/renovating-for-sustainability" element={<Renovation user={user} onLogout={handleLogout} />} />
          <Route path="/blog/planning-residential-project" element={<PlanningResidentialProject user={user} onLogout={handleLogout} />} />
        </Routes>
      </Router>
    </DarkModeProvider>
  );
